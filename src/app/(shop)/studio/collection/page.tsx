      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-white font-bold tracking-widest text-sm" style={{ fontFamily: 'Georgia, serif' }}>
              STUDIO
            </span>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={handleExit}
              className="flex items-center gap-1.5 text-pink-600 hover:text-pink-300 text-xs transition-colors"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          ...
          <div
            ...
            style={{ background: 'linear-gradient(to right, transparent, #ff006e, transparent)' }}
          />
        ...
        <div
          ...
          style={{ background: 'rgba(255,0,110,0.05)', border: '1px solid rgba(255,0,110,0.1)' }}
        >
          <p className="text-pink-300 text-sm">
            🔒 All orders are shipped in plain, unmarked packaging. Billing name: <strong>KC Retail</strong>.
          </p>
        </div>
      </div>
    </div>
